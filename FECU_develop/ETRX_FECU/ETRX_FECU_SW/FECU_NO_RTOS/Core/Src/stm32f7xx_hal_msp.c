...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, SteeringSensor_Pin|SUSP_F_R_Pin|Susp_F_L_Pin);

    HAL_GPIO_DeInit(GPIOA, APPS1_Pin|APPS2_Pin|BrakePedal_Pin);

    HAL_GPIO_DeInit(PitotSensor_GPIO_Port, PitotSensor_Pin);
