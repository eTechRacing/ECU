...
#define INVERTER_L_DATA 0xD2
#define INVERTER_R_DATA 0xD3
#define DASH_COOLING 0xA1
#define BRAKELIGHT 0x81
#define INVERTER_L_Rx 0xB5
#define INVERTER_R_Rx 0xB6
#define SF 0xE1
#define ACCU_TEMP 0x93
#define SDC 0xD1
...
//TX------------------------------------------------------------------------------
//TX-----------------------------------------------------------------------------------------------------
void message_cantx_TEMPERTARUES(CAN_HandleTypeDef hcan1, uint16_t *temperatures, uint8_t *TxData, CAN_TxHeaderTypeDef TxHeader);
...
void message_cantx_VOLTATJES(CAN_HandleTypeDef hcan1, uint16_t *voltatjes, uint8_t *TxData, CAN_TxHeaderTypeDef TxHeader);
