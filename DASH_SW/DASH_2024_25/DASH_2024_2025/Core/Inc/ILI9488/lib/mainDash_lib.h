...
// SPI handle externo (lo defines tú en tu main.c)
...
// Nucleo PINs
#define ILI9488_CS_GPIO_Port    GPIOD
#define ILI9488_CS_Pin          GPIO_PIN_0

#define ILI9488_DC_GPIO_Port    GPIOB
#define ILI9488_DC_Pin          GPIO_PIN_6

#define ILI9488_RST_GPIO_Port   GPIOB
#define ILI9488_RST_Pin         GPIO_PIN_7
